    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        {#if !isEditing && !isCreating}
          ...
          <div class="queries-header">
            <h3>SQL Queries</h3>
            <button class="btn-primary" on:click={createNewQuery}>
          ...
          <div class="queries-list">
            {#each queries as query (query.id)}
              <div class="query-item" class:inactive={!query.isActive}>
      ...
      <div class="modal-footer">
        {#if isEditing || isCreating}
          ...
          <button class="btn-save" on:click={saveQuery}>
            {isCreating ? 'Create Query' : 'Save Changes'}
          </button>
        {:else}
          <button class="btn-cancel" on:click={handleClose}>Close</button>
        {/if}
      </div>
    </div>
  </div>
